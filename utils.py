...
# TODO: NEED TO FIX ALL THIS TIMEFRAME STUFF
...
# a = "2015-10-16 10:00:00.000000"
# b = str(utc_now())
# diff = dhm(b,a)
# count = time_difference("1h", diff)
# print(diff)
# total = 2222
# count = 1111
# print("Download complete " + str(total) + "/" + str(count))

# time_diff = dhm(a,b)
# print(time_diff)

# print(time_difference("1h",time_diff))

# TODO: Figure out how to flip rows in pd dataframe O->N

# 2020-06-04 04:45:00.000000
# 2020-06-05 02:39:17.960788+00:00
# (0, 21, 54)
